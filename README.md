...
## 入坑React之三 Ant Design https://www.jianshu.com/p/5bfa394411e1
...
http://cn.mobx.js.org/intro/overview.html
http://051z.cc/food/javascript/p_499.html

看的资料：
https://www.codeproject.com/Articles/1223780/How-to-Build-a-React-App-Using-a-Mock-Contacts-API
https://www.ctolib.com/roadhog.html
...
https://doc.react-china.org/docs/thinking-in-react.html 中文

*******************************************

## "json-server --watch src/api/db.json --port 3001"

## "mockjs": "^1.0.1-beta3",建立mockdata/mock.js   mockjs  开启mock数据

## antd-mobile的引入及配置 npm install antd-mobile --save  import {Picker} from 'antd-mobile';

##  https://www.jianshu.com/p/5e6c620ff4d6 按需引入 npm install babel-plugin-import --save-dev  安装完毕后，在根目录新建文件，命名: .babelrc.js  然后！！！最重要的一步，把package.json中的babel配置给删掉，尤其是：react-app！！！ webpack.config.dev.js和webpack.config.prod.js中，都需要为resolve的extensions新增一项'.web.js'     npm install babel-preset-es2015  第二种解决方案： npm install react-app-rewired --save-dev


## 发现在改变antd-mobile主题时，在webpack配置less时报变量错误
...
- [Available Scripts](#available-scripts)
  - [npm start](#npm-start)启东开发
  - [npm test](#npm-test)单元测试
  - [npm run build](#npm-run-build)打包上传环境
  - [npm run testBuild](#npm-run-build)本地测试预览打包
  - [npm run eject](#npm-run-eject)配置展现
